...
public class VentanaPrincipal extends JFrame {
	...
	public void inicializar() {
		pedido.inicializar();
		getTxtPrice().setText("");
		getComboBox().setModel(new DefaultComboBoxModel<Articulo>(carta.getArticulos()));
		getComboBox().setSelectedIndex(0);
		getSpinnerUnits().setValue(1);
		getBtnNext().setEnabled(false);
		getTxtpnDiscount().setVisible(false);
		getLblDiscountIcon().setVisible(false);
			...
			btnAdd.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (pedido.getDescuento()) {
						getLblDiscountIcon().setVisible(true);
						getTxtpnDiscount().setVisible(true);
					}
	...
	private JButton getBtnCancel() {
		if (btnCancel == null) {
			...
			btnCancel.setBounds(720, 407, 97, 25);
		}
		return btnCancel;
	}
	...
	private JButton getBtnNext() {
		if (btnNext == null) {
			...
			btnNext.setBounds(613, 407, 97, 25);
		}
		return btnNext;
	}
	...
	private JLabel getLblDiscountIcon() {
		if (lblDiscountIcon == null) {
			...
			lblDiscountIcon.setVisible(false);
			lblDiscountIcon.setBounds(513, 288, 97, 108);
		}
