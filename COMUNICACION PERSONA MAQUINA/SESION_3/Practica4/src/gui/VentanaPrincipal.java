...
public class VentanaPrincipal extends JFrame {
	...
	private JLabel lblDiscountlogo;
	private JTextPane txtpnMchappyday;
	...
	public VentanaPrincipal() {
		...
		contentPane.add(getLblDiscountlogo());
		contentPane.add(getTxtpnMchappyday());
	...
	private JLabel getLblDiscountlogo() {
		if (lblDiscountlogo == null) {
			lblDiscountlogo = new JLabel("");
			lblDiscountlogo.setIcon(new ImageIcon(VentanaPrincipal.class.getResource("/img/sale101.png")));
			lblDiscountlogo.setBounds(33, 309, 97, 116);
		}
		return lblDiscountlogo;
	}

	private JTextPane getTxtpnMchappyday() {
		if (txtpnMchappyday == null) {
			txtpnMchappyday = new JTextPane();
			txtpnMchappyday.setForeground(Color.RED);
			txtpnMchappyday.setEditable(false);
			txtpnMchappyday.setFont(new Font("Arial Black", Font.PLAIN, 15));
			txtpnMchappyday
					.setText("            McHappyDay\r\n        10% de descuento\r\nen compras superiores a 50 \u20AC");
			txtpnMchappyday.setBounds(142, 336, 277, 103);
		}
		return txtpnMchappyday;
	}
